...
// AllReservations lists all reservations from database
func (m *postgresDBRepo) AllReservations() ([]models.Reservation, error) {
	...
	// always a good practice to check rows.Err() after scanning the rows
	if err = rows.Err(); err != nil {
		return reservations, err
	}
...
// AllNewReservations lists unprocessed reservations from database
...
// UpdateProcessedForReservation updates processed for a reservation in the database by id
...
func (m *postgresDBRepo) GetRestrictionsForRoomByDate(roomID int, start, end time.Time) ([]models.RoomRestriction, error) {
	...
	for rows.Next() {
		...
		roomRestrictions = append(roomRestrictions, rs)
	}
