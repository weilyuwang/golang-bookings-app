...
func getRoutes() http.Handler {
	...
	mux.Post("/user/login", Repo.Login)
	...
	mux.Get("/admin/reservations-calendar", Repo.AdminReservationCalender)
	mux.Post("/admin/reservations-calendar", Repo.AdminPostReservationCalender)
