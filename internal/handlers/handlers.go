...
func (m *Repository) ChooseRoom(w http.ResponseWriter, r *http.Request) {
	...
	// That convenience function offered by chi, chi.URLPara(r, "id") is really, really hard to test.
	// In truth, we don't even need to use it, since we can parse the URL and find the id on our own,
	// using this code:
...
func (m *Repository) Login(w http.ResponseWriter, r *http.Request) {
	_ = m.App.Session.RenewToken(r.Context()) // Good Practice!
...
// AdminDashboard shows dashboard in admin tool
...
// AdminShowReservation shows a single reservations in admin tool
...
// AdminPostShowReservation updates a single reservations in admin tool
...
// AdminPostReservationCalender handles changes of reservation calendar
